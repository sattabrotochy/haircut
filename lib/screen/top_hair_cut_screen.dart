...
class TopHairCutScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Top Hair Cut',style: TextStyle(color: Colors.white),),
      ...
      body: SafeArea(
          child: Container(
              ...
              child: GridView.builder(
                  ...
                  itemCount: TopHairCutList.length,
                  itemBuilder: (_, index) {
                    return hearStyleList(url: TopHairCutList[index]['image'],context: context);
                  }))),
    );
  }
}
