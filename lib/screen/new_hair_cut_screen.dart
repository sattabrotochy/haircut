...
class NewHairCutScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('New Hair Cut',style: TextStyle(color: Colors.white),),
      ...
      body: SafeArea(
          child: Container(
              ...
              child: GridView.builder(
                  ...
                  itemCount: newHairCutList.length,
                  itemBuilder: (_, index) {
                    return hearStyleList(url: newHairCutList[index]['image'],context: context);
                  }))),
    );
  }
}
