...
class HotHairCutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Hot Hair Cut',style: TextStyle(color: Colors.white),),
      ...
      body: SafeArea(
          child: Container(
              ...
              child: GridView.builder(
                  ...
                  itemCount: hotcut.length,
                  itemBuilder: (_, index) {
                    return hearStyleList(url: hotcut[index]['image'],context: context);
                  }))),
    );
  }
}
